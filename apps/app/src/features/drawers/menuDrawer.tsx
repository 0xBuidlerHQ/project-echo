...
const MenuActionItem = (props: { text: string }) => {
	return (
		<Button>
			<Box className="flex items-center transition-all duration-300 gap-2 text-red-500 hover:text-white hover:bg-red-500">
